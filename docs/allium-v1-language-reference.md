# Allium V1 language reference

> Canonical language reference for Allium V1, retrieved from
> [juxt/allium](https://github.com/juxt/allium/blob/main/references/language-reference.md)
> on 2026-02-28. All parsers, grammars and tooling in this repository
