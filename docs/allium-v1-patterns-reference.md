# Allium V1 patterns reference

> Canonical patterns library for Allium V1, retrieved from
> [juxt/allium](https://github.com/juxt/allium/blob/main/references/patterns.md)
> on 2026-02-28.
